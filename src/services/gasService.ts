 ...
 * Mata Pelajaran: Koding dan Kecerdasan Artifisial (Logika dan Algoritma)
 *
 * PANDUAN PEMASANGAN (HANYA 2 MENIT):
 * 1. Buat Spreadsheet baru di https://sheets.new
 * 2. Beri nama: "Rekap Nilai Tes Sumatif Koding dan AI Kelas V"
...
function doPost(e) {
  try {
    ...
    var kelas = contents.className || contents.kelas || "V";
    ...
    var mataPelajaran = contents.mataPelajaran || "Koding dan Kecerdasan Artifisial";
