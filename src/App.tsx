...
const STORAGE_QUESTIONS_KEY = 'sd3_loloan_timur_questions_koding_v2';
...
export default function App() {
  ...
  const [questions, setQuestions] = useState<Question[]>(() => {
    try {
      // Bersihkan key versi lama
      localStorage.removeItem('sd3_loloan_timur_questions_v2');
      localStorage.removeItem('sd3_loloan_timur_questions_pecahan_v3');
      localStorage.removeItem('sd3_loloan_timur_questions_pecahan_v4');
      localStorage.removeItem('sd3_loloan_timur_questions_koding_v1');

      const saved = localStorage.getItem(STORAGE_QUESTIONS_KEY);
      if (saved) {
        const parsed = JSON.parse(saved);
        // Pastikan jumlah dan struktur sesuai dengan distribusi soal Koding (35 butir: 20 PG, 5 PGK, 5 PGK Kategori, 5 Isian Singkat)
  ...
  // Reset soal ke 35 butir standar materi Koding & AI (20 PG, 5 PGK, 5 PGK Kategori, 5 Isian Singkat)
